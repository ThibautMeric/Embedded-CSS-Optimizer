try:
    ...
    import tkMessageBox
    from Tkinter import *
from Embedded_CSS_Optimizer.Read.ReadFile import *
from Embedded_CSS_Optimizer.Step1.EnableAddCSS import *
from Embedded_CSS_Optimizer.Step1.EnableAddHTML import *
from Embedded_CSS_Optimizer.Step1.OpenCSS import *
from Embedded_CSS_Optimizer.Step1.OpenHTML import *
from Embedded_CSS_Optimizer.Step1.RefreshStep1 import *
import platform

def InitializeStep1( lfStep1, lfStep2, lfWarning, lfStep3, WindowSetting, HtmlPath, CssPath, CssTable, HtmlTable, ModifierDict, WarningList, CBStep2State, ButtonList, ChoiceList, ChoiceList2):
    ...
    CallReadFile = lambda: ReadFile( lfStep1, lfStep2, lfWarning, lfStep3, CssPath, HtmlPath, CssTable, HtmlTable, ModifierDict, WarningList, CBStep2State, ButtonList, ChoiceList, ChoiceList2, WindowSetting)
