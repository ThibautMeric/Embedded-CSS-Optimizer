from Embedded_CSS_Optimizer.Step2.ConfigureCanvasStep2 import *
from Embedded_CSS_Optimizer.Step2.FillCanvasStep2 import *


def RefreshStep2(event, lfStep2, CBStep2State, ModifierDict, CssTable, ButtonList, ChoiceList, ChoiceList2, WindowSetting):
