try:
    ...
    import tkMessageBox
    from Tkinter import *
from Embedded_CSS_Optimizer.Others.Reset import *
from Embedded_CSS_Optimizer.Step3.IsClassic import *
from Embedded_CSS_Optimizer.Step3.IsDotMin import *
import platform

def InitializeStep3( lfStep1, lfStep2, lfWarning, lfStep3, WindowSetting, Version, CssTable, HtmlPath, CssPath, HtmlTable, WarningList, CBStep2State, ModifierDict, ChoiceList2):
    ...
    Callreset = lambda: Reset( lfStep1, lfStep2, lfWarning, lfStep3, HtmlPath, CssPath, CssTable, HtmlTable, WarningList, CBStep2State, ModifierDict, ChoiceList2, WindowSetting)
